...
{
	switch (-error_code) {
	case EOSR_DAMAGED_FILE:
		return "Potentially damaged or corrupt file";
		break;
	case EOSR_UNKNOWN_FILE:
		return "Unknown file";
		break;
	default:
		return "Bad osr error code";
	}
}
